...
**Next Documentation:** This file's own Manual E2E script (under Phase 9, now with live results) and the Blocked table (end of file), plus the new "Resolved this session" writeup right after it.
