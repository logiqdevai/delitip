...
export const demoReviews = [
  {
    ...
    stars: 5,
    tag: "Friendly vibe",
    note: "Maria was wonderful! Anticipated everything we needed before we even asked.",
    when: "1 hour ago",
  },
  {
    employee: "Alex K.",
    stars: 5,
    tag: "Great recommendations",
    note: "Made the best Espresso Martini in the city. Will definitely come back!",
    when: "3 hours ago",
  },
] as const;
